class Champion:
    __init__(self, data):
        ...
        self.herotype = data['tags'][0]
        self.alttype = str((len(data['tags']) > 1 and data['tags'][1]) or '')
        self.rangetype = rangetype
        self.date = ''
        self.patch = ''
        self.health = data['info']['defense']
        self.attack = data['info']['attack']
        self.spells = data['info']['magic']
        self.difficulty = data['info']['difficulty']
        self.ip = ''
        self.rp = ''
        self.passive = Passive(data['passive'])
